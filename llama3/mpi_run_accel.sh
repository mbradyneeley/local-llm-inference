...
HOST="$MAIN_MACHINE,sabercore-a100-002,sabercore-a100-003,sabercore-a30-001,sabercore-a30-002,sabercore-a30-003,sabercore-a30-004"
...
mpirun -np $N_PROCESS \
  ...
  bash -c '
    ...
    --config_file ./accelerate_config_multigpu_brady_accel.yaml \
    --multi_gpu \
