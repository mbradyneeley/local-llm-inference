...
MAIN_MACHINE="droidnode001" # Replace with CPU
MAIN_PROCESS_IP=$(host $MAIN_MACHINE | cut -d" " -f 4)
HOST="$MAIN_MACHINE,sabercore-a100-001,sabercore-a100-002,sabercore-a100-003,sabercore-a30-001,sabercore-a30-002,sabercore-a30-003,sabercore-a30-004"
...
mpirun -np $N_PROCESS \
  ...
  -wd $WORKDIR \
  bash -c '
	/home/matthewn/.conda/envs/kuda/bin/deepspeed --num_gpus 7 /home/matthewn/projects/GPT_Diagnosis/llama3/deepspeed/run_llama3_deepspeed.py
  '
